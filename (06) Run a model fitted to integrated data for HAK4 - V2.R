###############################################################################################################################
##
##  (06) This script runs a model fitted to integrated data (i.e., TRAWL BT data + COD BT data) for HAK4 -
##  Version 2 (V2): Here the model is a spatially-varying catchability model
##  
###############################################################################################################################

######## Set the output directory
if ( !dir.exists( paste0( DIR$Output, "\\HAK4_Integrated_data_V2" ) ) ) {
	dir.create( paste0( DIR$Output, "\\HAK4_Integrated_data_V2" ) )
} 
OutputDir <- paste0( DIR$Output, "\\HAK4_Integrated_data_V2" )
setwd( OutputDir )
